...
#define ENTRY_MODE_FORWARD  0x06                         // increment mode
#define ENTRY_MODE_BACKWARD 0x04                         // increment mode
...
// define the controller PORT which the LCD is connected to
#define LCD_PORT            PORTA
// mask defining zhe high nibble pins
#define LCD_HIGH_NIBBLE     0x3c
#define LCD_DATA_OFFSET     2
// LCD enable -> define as bitmask, e.g. for PIN4 use 0b00010000 or 0x10
#define LCD_EN              PIN7_bm
// LCD register select line -> define as bitmask, e.g. for PIN4 use 0b00010000 or 0x10
#define LCD_RS              PIN6_bm
// LCD read/write line -> not needed with LCD Keypad Shield
//#define LCD_RW       PORTCbits.RC5
    
#define BGL_PORT            PORTC
#define BGL_SW              PIN0_bm     // LCD power pin

#define NB_LINES    2                       // Number of display lines
#define NB_COL      16                      // Number of characters per line
    
#define SET_PIN(port, pinMsk) port.OUTSET = pinMsk
#define RST_PIN(port, pinMsk) port.OUTCLR = pinMsk
